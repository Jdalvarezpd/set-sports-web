<?php session_start();
	...
	$noticias = $conexion->prepare("SELECT * FROM noticias WHERE id_evento = '$id_evento' ORDER BY fecha DESC LIMIT 100");
	$noticias->execute();
	...
	<div class="container-fluid" style="padding: 0px;">
        ...
        <div class="row" style="margin: 0;">
        	<div class="col-md-12">
				...
				<div class="col-md-3">
					<div class="card" style="width: 100%; margin-bottom: 1em; border-radius: 0;">
					  <img class="card-img-top" src="<?php echo $not['imagen'] ?>" alt="Card image cap">
					  <div class="card-body">
					    <p class="card-title" style="font-size: .9em; font-weight: bold;"><?php echo $not['titulo'] ?></p>
					    <p class="card-text" style="font-size: .8em;"><?php echo $not['descripcion'] ?></p>
					  </div>
					</div>
				</div>
				<?php endforeach; ?>
